...
The map of Europe is from the `mapdata` package. The antibiotic consumption data and the *E. coli* resistance rasyes from year 2015 are taken from the [European Centre for Disease Prevention and Control.](ecdc.europa.eu)
```{r}
