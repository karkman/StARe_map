...
The map of Europe is from the `mapdata` package. The antibiotic consumption data and the *E. coli* resistance rates (combined resistance: third-generation cephalosporin, fluoroquinolones and aminoglycoside) for year 2015 are from the [European Centre for Disease Prevention and Control.](ecdc.europa.eu)
```{r}
...
p1 <- ggplot() + 
  ...
  labs(x="Longitude", y="Latitude", title = "Antibiotic use in Europe", caption = "source: ecdc.europa.eu") + scale_fill_gradient(name="scale", high="red", low="#FFFF99", na.value = "grey80")
...
p2 <- ggplot() + 
  ...
  theme(panel.grid = element_blank(), panel.background = element_blank(), 
        plot.title = element_text(size=10, face = "bold"), legend.position = "none") +
  labs(x="Longitude", y="Latitude", title = "Clinical resistance (E. coli)", caption = "source: ecdc.europa.eu") + scale_fill_gradient(name="E. coli\nresistant isolates", high="red", low="#FFFF99", na.value = "grey80")
...
p3 <- ggplot() + 
  ...
  theme(panel.grid = element_blank(), panel.background = element_blank(), 
        plot.title = element_text(size=10, face = "bold"), legend.position = "none") +
  labs(x="Longitude", y="Latitude", title = "ARGs in raw sewage", caption = "source: this study") + scale_fill_gradient(name="Influent\nAR prevalence", high="red", low="#FFFF99", na.value = "grey80")
...
p4 <- ggplot() + 
  ...
  theme(panel.grid = element_blank(), panel.background = element_blank(), 
        plot.title = element_text(size=10, face = "bold"), legend.position = "none") +
  labs(x="Longitude", y="Latitude", title = "ARGs in treated sewage", caption = "source: this study") + scale_fill_gradient(name="Effluent\nAR prevalence", high="red", low="#FFFF99", na.value = "grey80")
